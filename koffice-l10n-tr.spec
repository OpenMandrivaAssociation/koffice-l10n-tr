...
+ Revision: 305064
- add source and spec
- Created package structure for koffice-l10n-tr.
...
* Tue Jul 26 2005 Laurent MONTEL <lmontel@mandrakesoft.com> 1.4.1-koffice-l10n-tr-1.6.2.tar.bz2
- 1.4.1
